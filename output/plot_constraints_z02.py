...
modelName = raw_input('model folder name (press enter for default): ')
print "Check 'plots' folder in " + modelName
if modelName != '':
    dir2 = modelName + '/'
...
r.savepng(outdir+'1-'+modelName+'MassFunctions', xsize=1700, ysize=512, fig=fig)
##### ====================== #####
...
fig.subplots_adjust(hspace=0, wspace=0, left=0, bottom=0, right=1.0, top=1.0)
r.savepng(outdir+'2-'+modelName+'HIfrac_MassMet', xsize=768, ysize=700)
##### =================================== #####
...
r.savepng(outdir+'3-'+modelName+'BHBM', xsize=768, ysize=400)
##### ================================ #####
...
r.savepng(outdir+'4-'+modelName+'BTF', xsize=768, ysize=400)
##### ============================= #####
...
fig.subplots_adjust(hspace=0, wspace=0, left=0, bottom=0, right=1.0, top=1.0)
r.savepng(outdir+'5-'+modelName+'HIH2Surface', xsize=768, ysize=700)
##### ========================== #####
